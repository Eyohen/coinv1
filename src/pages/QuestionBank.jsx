...
const usersData = [
  { id:1, firstName: 'Aquarius', lastName: '1 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'USA', date: '2023-01-01' },
  { id:2, firstName: 'Busy minds', lastName: '2 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Non-Teaching', country: 'Nigeria', date: '2023-01-01' },
  { id:3,firstName: 'Holy Child', lastName: '3 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Pending', type: 'Teaching', country: 'London', date: '2023-01-01' },
  { id:4,firstName: 'Federal Girls', lastName: '4 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Pending', type: 'Non-Teaching', country: 'Ghana', date: '2023-01-01' },
  { id:5,firstName: 'Life Fort', lastName: '5 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'Japan', date: '2023-01-01' },
  { id:6,firstName: 'Simi', lastName: '6 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'Egypt', date: '2023-01-01' },
  { id:7,firstName: 'Joshua', lastName: '7 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'Morocco', date: '2023-01-01' },
  { id:8,firstName: 'Faith', lastName: '8 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'Spain', date: '2023-01-01' },
  { id:9,firstName: 'Bassey', lastName: '9 Churchill road', email: 'john@example.com', phone: '123-456-7890', status: 'Completed', type: 'Teaching', country: 'USA', date: '2023-01-01' },
];
...
const QuestionBank = () => {
  ...
  return (
    ...
    <div className='flex-1 ml-[300px] p-9'>
         <p className='font-bold text-3xl'>Questions</p>
    ...
    <div class="absolute inset-y-0 left-0 flex items-center px-2">
       ...
       <option value="">Filter</option>
        ...
        <Link to={'/createexamination'}><button className='bg-blue-500 text-white px-4 rounded-lg text-xl font-semibold flex items-center gap-x-2 py-2'><BsPlusLg  size={23}  color='white'/>Create Examination</button></Link>
      </div>

      <div className='bg-white py-6 rounded-xl border'>
        <p className='text-2xl font-semibold px-6 '>Questions</p>
        ...
        <tbody>
          {currentUsers.map((user, index) => (
            <tr key={user.id} onClick={() => setShowModal(!showModal)} className='border-b border-gray-300 text-gray-500 '>
              ...
              <td className="py-2 px-3">{user.status === "Completed" ? <p className='bg-green-100 text-green-600 font-semibold px-3 rounded-md max-w-[120px]'><div className='flex gap-x-1 items-center'><GoDotFill color='green' size={15} /><p>Completed</p></div></p> : <p className='bg-red-100 text-red-600 font-semibold px-2 rounded-md max-w-[120px]'><div className='flex gap-x-1 items-center'><GoDotFill color='red' size={15}/>Pending</div></p>}</td>
