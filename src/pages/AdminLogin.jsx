...
const AdminLogin = () => {
  ...
  return (
    <div className='bg-blue-200 py-[320px] flex justify-center items-center h-[100vh]'>

      <div className='flex justify-center items-center max-w-[600px] h-[450px] py-6 bg-white px-64 rounded-2xl shadow-xl'>
    <form onSubmit={handleSubmit} >

      <p className='font-bold text-2xl pt-3'>Log Into Admin Account</p>
      <p className='text-gray-600 '>Please fill in your information</p>

     
      <div className='pt-10'>
        <p>Email</p>
        <input className='border py-2 px-2 w-[450px] rounded-md' type="email" name="email" value={formData.email} onChange={handleChange} required />
      </div>
      <div className='pt-6'>
        <p>Password</p>
    ...
    />
      ...
      <div className='pt-9'>
      <Link to={'/dashboard'}><button className='bg-blue-400 py-2 px-2 w-[450px] text-white shadow-xl rounded-md' type="submit">Login</button></Link>
      </div>
